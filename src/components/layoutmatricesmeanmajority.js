...
function LayoutMatricesMeanMajority(props) {
    ...
    function loadMatricesLayout(groundTruth,predictions,selectedStation,selectedYear,selectedModels,mode,coloringScheme) {
        ...
        //     .attr('id','predictionHeatMatricesDiv'+mode)
...
}, [selectedStation, selectedYear, selectedModels, coloringScheme, stepdiv, stepmaj]);
...
// // QUESTION: WHAT IS THIS CODE HERE???
// if (mode === 'maj' || mode === 'div') {
